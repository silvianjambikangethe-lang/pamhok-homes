...
export const metadata: Metadata = {
  ...
  openGraph: { title: pageTitle("Staff Login"), description: "Staff sign-in for Pamhok Homes." },
  twitter: { title: pageTitle("Staff Login"), description: "Staff sign-in for Pamhok Homes." },
};
