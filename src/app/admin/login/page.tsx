    ...
    <div className="flex min-h-[70vh] items-center justify-center px-4">
      <div className="w-full max-w-sm rounded-2xl border border-taupe/20 bg-surface p-8 shadow-warm">
        ...
        <button
          ...
          className="focus-ring mt-6 flex w-full items-center justify-center gap-2 rounded-full border border-taupe/25 bg-page px-6 py-3 text-sm font-semibold text-ink transition-colors hover:bg-taupe/10 disabled:opacity-60"
        >
